...
class OnTapMobTab extends StatefulWidget {
  OnTapMobTab(
      {super.key,
      this.btext = '',
      this.imagepath = '',
  ...
  @override
  State<OnTapMobTab> createState() => _OnTapMobTabState();
}

class _OnTapMobTabState extends State<OnTapMobTab> {
  bool _isHover = false;
  @override
        ...
        children: [
          Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(15),
                color:
                    _isHover ? Colors.white24 : AppColors.backgroundThemeColor,
              ),
              child: Center(
                child: SizedBox(
                  height: 30,
